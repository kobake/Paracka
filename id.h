...
#define IDM_FUNC_START		(IDM_FUNC_BEGIN+2)
#define IDM_FUNC_PASS		(IDM_FUNC_BEGIN+3)
#define IDM_FUNC_VIEW		(IDM_FUNC_BEGIN+4)
#define IDM_FUNC_TURN		(IDM_FUNC_BEGIN+5)
#define IDM_FUNC_END		(IDM_FUNC_BEGIN+6)
